                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    @error('email')
                        <div class="alert alert-danger text-center" role="alert">
                            {{ $message = "Ces informations d'identification ne correspondent pas à nos dossiers." }}
                        </div>
                    @enderror
                    ...
                    <a href="{{ route('admin.login') }}" class="btn btn-secondary">Connectez-vous en tant qu'administrateur</a>
                    </div>
