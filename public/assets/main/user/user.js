            ...
            if(email != "" && /^[a-z0-9._-]+@[a-z0-9._-]+\.[a-z]{2,6}$/.test(email)){
                ...
                if(passwordLength >= 8){
                    ...
                    if(password == password_confirm){
                        ...
                        if(agreeTerms.is(':checked')){
                            ...
                            (res != "exist") ? $('#form-register').submit()
                                :   ($('#email').addClass('is-invalid'),
                                    ...
                                    $('#error-register-email').text("Cette adresse email est déjà utilisée!"));
                        ...
                        $('#error-register-password-confirm').text("Vos mots de passe doivent être identiques!");
                    }
                }else{
                ...
                $('#email').addClass('is-invalid');
                $('#email').removeClass('is-valid');
                $('#error-register-email').text("Votre adresse email n'est pas valide!");
            }
        }else{
            $('#lastname').addClass('is-invalid');
            $('#lastname').removeClass('is-valid');
            $('#error-register-lastname').text("Le nom n'est pas valide!");
        }
    }else{
